...
HBITMAP vmsSkinMgr::bmp(UINT nID)
{
	static UINT aIDs [] = {
		...
		IDB_GROUPSMENU, IDB_LOGSTATES, //IDB_MUTE,
		IDB_SCHEDULER_SEL, IDB_SHEDULER, IDB_SITELIST, IDB_SITELIST_SEL,
	...
	static LPCSTR ppszNames [] = {
		...
		"dlinfo", "filelist", "filelist_sel", "go", "groups", "groupsmenu_d",
		"groupsmenu", "logstat", //"mute",
