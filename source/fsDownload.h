...
public:
	...
	void setStateFlags (DWORD _dwFlags) {LockStateSection (true); dwState |= _dwFlags; LockStateSection (false);}
	void removeStateFlags (DWORD _dwFlags) {LockStateSection (true); dwState &= ~_dwFlags; LockStateSection (false);}
