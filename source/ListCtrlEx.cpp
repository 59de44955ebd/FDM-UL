...
void CListCtrlEx::SaveState(LPCSTR pszName)
{
	...
	_App.get_SettingsStore ()->WriteProfileBinary (_T ("ListViews"), strIndexes, (LPBYTE)m_aIndex, m_cTotalCols * sizeof (int));
	_App.get_SettingsStore ()->WriteProfileBinary (_T ("ListViews"), strWidthes, (LPBYTE)piWidthes, m_cTotalCols * sizeof (int));
